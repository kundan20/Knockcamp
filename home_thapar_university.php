...
@media (max-width:571px){
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" style="margin-top: 0px">
      <ol class="carousel-indicators">
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="carousel-item active" style="background: url('TU.jpg') center center no-repeat;max-width: 1500px; max-height: 450px; background-size: cover"  >
        </div>
  ...
  <?php global $connection;
        ...
        <div class="carousel-item" style="background: url('Carousal/<?php echo $image ?>') center center no-repeat; max-width: 1500px; max-height: 450px" >
        </div>
            <?php } ?>  
  ...
  <div class="container">
    ...
    <div class="row">
       ...
       <?php global $connection;
                $sql="select * from articles order by id desc LIMIT 0,8";
                $execute=mysqli_query($connection,$sql);
                while($rows=mysqli_fetch_array($execute))
                {
                    $id =$rows['id'];
