 ...
 elseif($_POST["Password"]!==$_POST["Confirmpassword"])
    {
        ...
        $sql="INSERT INTO general_admin(Email,Password,addedby)
        Values('$username','$pass_hash','$Admin')";
 ...
 ?>         
    ...
    <div class="row">
        ...
        <ul id="Side_Menu" class="nav nav-pills nav-stacked">
            ...
            <li  class="active"><a href="Gregister.php"><span class="glyphicon glyphicon-log-out"></span>General registeration</a></li>
        ...
        <h1>Manage Admins</h1>
           <div><?php echo message();
            ...
            <?php   global $connection;
                $sql="Select * from general_admin order by id desc";
                $execute=mysqli_query($connection,$sql);
                    $srno=0;
                while($rows=mysqli_fetch_array($execute))
                {
                    ...
                    <td><a href="DeleteGeneral.php?id=<?php echo $id; ?>"><span class="btn btn-danger btn-block">Delete</span></a></td>
                    </tr>   
                <?php    
                }
                ?>
