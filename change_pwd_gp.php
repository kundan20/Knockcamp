...
if (isset($_POST['submit'])) {
    ...
    $pwd = ("SELECT password FROM general_admin WHERE Email='$email'");
...
//echo $oldpwddb;
    ...
    {
      $update_pwd = "UPDATE general_admin SET Password='$new_hash' where Email='$email'";
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-md-offset-3">
          ...
          <div style="padding: 20px;" id="form-olvidado">
            <form action ="change_pwd_gp.php" accept-charset="UTF-8" role="form" method="post">
              <fieldset>
