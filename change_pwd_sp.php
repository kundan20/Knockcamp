...
if (isset($_POST['submit'])) {
    ...
    $pwd = ("SELECT password FROM society_admins WHERE Email='$email'");
...
//echo $oldpwddb;
    ...
    {
      $update_pwd = "UPDATE society_admins SET password='$new_hash' where Email='$email'";
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-md-offset-3">
          ...
          <div style="padding: 20px;" id="form-olvidado">
            <form action ="change_pwd_sp.php" accept-charset="UTF-8" role="form" method="post">
              <fieldset>
