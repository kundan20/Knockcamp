      ...
      <div class="row">
       ...
       <?php  
         ...
         <div class="caption">
             ...
             <p class="description"><strong>Date and Time:<?php echo $datetime; ?></strong><br><strong>Author: <?php echo $author; ?></strong></p>
                        <p class="post"><?php echo $article; ?></p>
                    </div>
          </div>
          </div>
      </div>
