    ...
    <div class="row">
        <div class="col-sm-2 ">
            ...
            <ul id="Side_Menu" class="nav nav-pills nav-stacked">
                <li  ><a href="experience_form.php"><span class="glyphicon glyphicon-list-alt"></span> Interview</a></li>
                <li class="active" ><a href="addarticle.php"><span class="glyphicon glyphicon-plus"></span> Add Articles</a></li>
