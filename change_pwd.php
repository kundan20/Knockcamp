        ...
        if(isset($_POST['option']))
          {
            ...
            {
            header("location:change_pwd_gp.php");             }
            elseif($option == "Society Admin")
            {
            header("location:change_pwd_sp.php");  
            }
             elseif($option == "Student Admin")
            {
            header("location:change_pwd_stp.php");              }
            else
            {
            header("location:change_pwd_tp.php");  
            }
      ...
      <div class="row">
       ...
       <div class="col-md-6 col-md-offset-3" style="margin-top: 80px">
          ...
          <div style="padding: 20px;" id="form-olvidado">
            <form action="change_pwd.php" accept-charset="UTF-8" role="form" id="login-form" method="post" >
              <fieldset>
                <label>You are</label>
