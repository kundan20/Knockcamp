...
<section class="parent">
  <div class="child">
    <?php 
        ...
        location.replace("experience_form.php");
        </script>';
              ...
              echo '<script type="text/javascript">
        location.replace("addarticle.php");
        </script>';
              } 
               elseif($option=="Teacher Admin")
                ...
                echo '<script type="text/javascript">
        location.replace("notice_form.php");
        </script>';
                }
                elseif($option=="Society Admin")
                {
                  ...
                  echo '<script type="text/javascript">
        location.replace("societyadmin/Dashboard.php");
        </script>';
                }
            ...
            <form action="student_admin.php" accept-charset="UTF-8" role="form" id="login-form" method="post" >
              <fieldset>
                ...
                <div class="form-group input-group">
                  ...
                  <input class="form-control" placeholder="Roll No" name="username" required="" autofocus="">
                </div>
                <div class="form-group input-group">
                  <span class="input-group-addon">
